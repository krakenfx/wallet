...
export const SimpleSlide: React.FC<PropsWithChildren & Props> = ({ title, animation, onButtonPress, buttonText, children }) => {
  const [lottieLayout, setLottieLayout] = useState<LayoutRectangle>();

  const onAnimationLayout = (e: LayoutChangeEvent) => setLottieLayout(e.nativeEvent.layout);
